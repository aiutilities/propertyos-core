  ...
  return {
    ...
    coverage: {
      ...
      goodsReceiptPostingContract:
        true,
      stockTransferFoundationContract:
        true,
      stockTransferDispatchContract:
        true,
      ...
      materialReturnFoundationContract:
        true,
      materialReturnPostingContract:
        true,
      materialReturnContract:
        true,
      stockAdjustmentFoundationContract:
        true,
      ...
      reservationFoundationContract:
        true,
      reservationFulfillmentContract:
        true,
      reservationReleaseContract:
        true,
      reservationExpiryContract:
        true,
