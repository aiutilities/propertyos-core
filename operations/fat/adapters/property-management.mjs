...
const propertyTests = [
  "src/core/property/services/property.service.integration-spec.ts",
];
...
async function runPropertyManagementSuite() {
  const startedAt =
  ...
  checks.push(
    await runCommand({
      ...
      cwd: backendRoot,
      label:
        "property-management-test-execution",
    }),
  );
